...
export default function TopActiveUsers({ profiles }) {
  return (
    <>
      <div className="kt-portlet kt-portlet--height-fluid">
        <div className="kt-portlet__head">
          <div className="kt-portlet__head-label">
            <h3 className="kt-portlet__head-title">Most Active</h3>
          </div>
          ...
          <div className="kt-widget4">
            {profiles && profiles.map((profile, index) => (
              <div key={index} className="kt-widget4__item ">
                ...
                <a className="btn btn-sm btn-label-brand">{profile.votes_count || 0} votes</a>
              </div>
            ))}
          </div>
        </div>
