...
export default function Payment() {
  ...
  React.useEffect(() => {
    api.getPaymentData(values.dateFrom, values.dateTo)
      .then(result => {
    ...
    <>
          ...
          <div className="row row-full-height">
            <div className="col-sm-4 col-md-4 col-lg-4">
              <Portlet className=" kt-portlet--border-bottom-brand">
                <PortletBody fluid={true}>
                  <QuickStatsChart
                    value={values.data && values.data.revenue || 0}
                    desc="Revenue"
                  />
                </PortletBody>
              </Portlet>
            ...
            <div className="col-sm-4 col-md-4 col-lg-4">
              ...
              <Portlet className=" kt-portlet--border-bottom-brand">
                <PortletBody fluid={true}>
                  <QuickStatsChart
                    value={values.data && values.data.transaction || 0}
                    desc="Transactions"
                  />
                </PortletBody>
              </Portlet>
            ...
            <div className="col-sm-4 col-md-4 col-lg-4">
              <Portlet className=" kt-portlet--border-bottom-brand">
                <PortletBody fluid={true}>
                  <QuickStatsChart
                    value={values.data && values.data.total_products || 0}
                    desc="Sold Products"
                  />
                </PortletBody>
              </Portlet>
      ...
      <div className="row">
        <div className="col-xl-6">
          <BestSellingMovies profiles={values.data && values.data.best_selling_movies || []}/>
        </div>
        <div className="col-xl-6">
          <TopBuyers profiles={values.data && values.data.top_buyers || []}/>
        </div>
      </div>
    </>
  );
