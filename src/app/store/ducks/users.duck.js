...
export const actionTypes = {
  SetLoading: "[SetLoading-User] Action",
  SetActionProgress: "[SetActionProgress-User] Action",
  Create: "[Create-User] Action",
  Update: "[Updated-User] Action",
  Delete: "[Delete-User] Action",
  Load: "[Load-User] Action",
  LoadAll: "[LoadAll-User] Action",
  LoadRequest: "[LoadRequest-User] Action",
};
