...
export const actionTypes = {
  SetLoading: "[SetLoading-Plan] Action",
  SetActionProgress: "[SetActionProgress-Plan] Action",
  Create: "[Create-Plan] Action",
  Update: "[Updated-Plan] Action",
  Delete: "[Delete-Plan] Action",
  Load: "[Load-Plan] Action",
  LoadAll: "[LoadAll-Plan] Action",
  LoadRequest: "[LoadRequest-Plan] Action",
};
